        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="blog__details__title">
                    ...
                    <h2>โปรแกรมสำหรับร้าน Tour Shop / Jewelry<br /> </h2>
                </div>
                ...
                <div class="blog__details__text">
                    ...
                    <p>
                        ...
                        <ul>
                            ...
                            <li>บันทึกข้อมูลรายชื่อของลูกค้าที่ใช้บริการในรูปแบบ Name list</li>
                    ...
                    <p>
                        ...
                        <ul>
                            ...
                            <li>บันทึกข้อมูลลูกค้าในบิลขาย (ผ่านเครื่องอ่าน Passport)</li>
                            <div class="blog__details__pic">
                    ...
                    <p>
                        7.ประมวลผลบิลขายเพื่อตัดสต๊อกสินค้า
                        <ul>
                            <li>ระบบสามารถประมวลบิลขายเพื่อตัดสต๊อกสินค้าผ่านระบบสต๊อกเอง หรือทำงานร่วมกับโปรแกรมอื่นภายนอกได้ผ่านการ Interface ของแต่ละโปรแกรม</li>
                            <div class="blog__details__pic">
