        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="blog__details__title">
                    ...
                    <h2>โปรแกรมสำหรับร้าน Department Store<br /> </h2>
                </div>
                <div class="blog__details__pic">
                    <img src="<?= base_url('img/products/jewelry/department.jpg'); ?>" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
                <div class="blog__details__text">
                    ...
                    <p>
                        ...
                        <ul>
                            <li>บันทึกข้อมูลสินค้า ราคาขายตามชนชาติ</li>
                    ...
                    <p>
                        ...
                        <ul>
                            <li>ระบบสามารถประมวลบิลขายเพื่อตัดสต๊อกสินค้าผ่านระบบสต๊อกเอง หรือทำงานร่วมกับโปรแกรมอื่นภายนอกได้ผ่านช่องการ Interface ของแต่ละโปรแกรม</li>
                            <div class="blog__details__pic">
